...
public class BookingSlotMapper {
	...
	public BookingSlotDto mapToBookingDto(BookingSlot slot) {
		return new BookingSlotDto(slot.getId(),slot.getCenter_id(),slot.getDate(),slot.getSlot());
	}
	public BookingSlot mapToBooking(BookingSlot slot) {
		return new BookingSlot(slot.getId(),slot.getCenter_id(),slot.getDate(),slot.getSlot());
	}
