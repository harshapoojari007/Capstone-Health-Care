...
public class TestResultDao {
	...
	public TestResult updateTestResult(int id,TestResult updatedTestResult) throws IdNotFoundException {
	    ...
	    if (updatedTestResult.getTestCondition() != null) { // Assuming 0 is not a valid value for testReading
	        existingTestResult.setTestReading(updatedTestResult.getTestReading());
	    }
	    if (updatedTestResult.getTestReading() != 0) {
	        existingTestResult.setTestCondition(updatedTestResult.getTestCondition());
	    }
