...
public class DiagnosticTestController {
	...
	@GetMapping("/diagnostictest/normalvalue/{testName}")
	public ResponseEntity<?> getNormalValueOfTest(@PathVariable("testName")String testName) {
		return service.getNormalValueOfTest(testName);
	}
	@GetMapping("/diagnostictest/unit/{testName}")
